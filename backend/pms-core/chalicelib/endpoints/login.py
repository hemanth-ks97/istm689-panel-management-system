...
from chalicelib.utils import create_token, verify_token
...
def create_new_token():
    ...
    try:
        json_body = login_routes.current_request.json_body
...
@login_routes.route(
    "/panel", methods=["POST"], content_types=[REQUEST_CONTENT_TYPE_JSON]
)
def get_login_panel():
    incoming_json = login_routes.current_request.json_body
